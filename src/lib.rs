...
#[derive(Debug)]
pub struct CryptoAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoAPI processing");
    
    let mut processor = CryptoAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoAPIProcessor::new(false);
